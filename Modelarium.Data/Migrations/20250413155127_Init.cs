        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Version = table.Column<string>(type: "TEXT", maxLength: 2147483647, nullable: false),
                    Parameters = table.Column<string>(type: "TEXT", maxLength: 2147483647, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Conversations_Models_ModelId",
                        column: x => x.ModelId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sender = table.Column<string>(type: "TEXT", maxLength: 2147483647, nullable: false),
                    Content = table.Column<string>(type: "TEXT", maxLength: 2147483647, nullable: false),
                    IsCodeBlock = table.Column<bool>(type: "INTEGER", maxLength: 2147483647, nullable: false),
                    FilePath = table.Column<string>(type: "TEXT", maxLength: 2147483647, nullable: true),
